...
function OverviewTab({
 ...
 className={`w-full min-h-[72px] sm:min-h-[80px] max-h-28 resize-y p-3 border shadow-inner transition-all duration-350 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] font-sans rounded-2xl ${
