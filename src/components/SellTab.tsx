...
export default function SellTab({ orders, onAddOrder, selectedBranch, theme }: SellTabProps) {
 ...
 <div className="space-y-3 mb-6 bg-zinc-950/5 dark:bg-zinc-950/40 p-4 rounded-2xl border border-zinc-150 dark:border-zinc-850/60 hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)] transition-all duration-300">
 ...
 className={`w-full p-2.5 pl-3 text-xs rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] focus:border-yellow-500 focus:outline-none transition-all ${
 isLight 
 ...
 className={`p-2.5 text-xs rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] focus:border-yellow-500 focus:outline-none transition-all font-sans font-semibold cursor-pointer ${
 isLight 
 ...
 className="w-4 h-4 rounded border-zinc-400 text-amber-500 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] focus:border-yellow-500 cursor-pointer shadow-sm disabled:opacity-50 active:scale-[0.98] hover:-translate-y-0.5 hover:shadow transition-all duration-200"
 />
 </div>
 <button 
 type="button"
 ...
 className={`w-full mt-1.5 p-2.5 text-xs font-bold rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] focus:border-yellow-500 transition-all ${
 isLight 
 ...
 className={`w-full mt-1.5 p-2.5 text-xs rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] focus:border-yellow-500 transition-all ${
 isLight 
 ...
 className={`w-full mt-1.5 p-2.5 text-xs rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_8px_rgba(234,179,8,0.4)] focus:border-yellow-500 font-mono transition-all ${
 isLight 
 ? 'bg-zinc-50 border border-zinc-200 text-zinc-900' 
 : 'bg-zinc-950 border border-zinc-800 text-white'
 }`}
