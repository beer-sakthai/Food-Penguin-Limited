...
export default function LoginScreen({ onLogin, theme = 'dark' }: LoginScreenProps) {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center font-sans ${isLight ? 'bg-zinc-100' : 'bg-black'}`}>
      <div className={`w-full max-w-md p-8 rounded-3xl border shadow-xl ${isLight ? 'bg-white border-zinc-200 shadow-zinc-200/50' : 'bg-zinc-950 border-zinc-900 shadow-amber-500/5'}`}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2.5 rounded-xl border text-sm transition-all outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_12px_rgba(234,179,8,0.4)] ${ isLight ? 'bg-zinc-50 border-zinc-200 text-zinc-900 focus:bg-white' : 'bg-zinc-900 border-zinc-800 text-white focus:bg-black' }`}
          ...
          {isRegistering && (
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2.5 rounded-xl border text-sm transition-all outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-[0_0_12px_rgba(234,179,8,0.4)] appearance-none cursor-pointer ${ isLight ? 'bg-zinc-50 border-zinc-200 text-zinc-900 focus:bg-white' : 'bg-zinc-900 border-zinc-800 text-white focus:bg-black' }`}
              >
