    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      <div className="xl:col-span-2 space-y-6">
        ...
        <div className="bg-zinc-950 border border-zinc-900 rounded-3xl p-6 shadow-sm space-y-4">
          ...
          <textarea
            ...
            className="w-full h-16 p-3 text-xs bg-zinc-900 border border-zinc-800 rounded-xl focus:outline-none focus:ring-1 focus:ring-orange-500 font-sans shadow-inner text-white"
          />
          ...
          <div className="text-right">
            <button
              ...
              className="px-5 py-2.5 bg-zinc-900 hover:bg-zinc-850 disabled:bg-zinc-950 text-white font-bold text-xs rounded-xl transition-all inline-flex items-center gap-2 shadow-md"
            >
              {loadingSuggestion ? (
                <>
      ...
      <div className="bg-zinc-900 rounded-3xl border border-zinc-850 p-6 shadow-sm max-h-[550px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3.5">
            <div>
              ...
              <input
                ...
                className="w-full mt-1.5 p-2.5 bg-zinc-950 border border-zinc-800 text-white rounded-xl text-xs focus:ring-1 focus:ring-orange-500 focus:outline-none font-mono"
              />
            </div>
            <div>
          ...
          <button
            type="submit"
            className="w-full py-2.5 mt-2 bg-zinc-950 hover:bg-zinc-850 text-white font-bold text-xs rounded-xl transition-colors inline-flex items-center justify-center gap-1.5 shadow-md border border-zinc-800"
          >
